...
public class Information_Ferris extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_information__ferris);

        serverResp = (TextView)findViewById(R.id.ferris_resp);
        listView = (ListView) findViewById(R.id.list_ferris);

        String jsonString = "";

        try {
//            URL url = new URL("http://192.168.56.1:8000/Ferris");
            URL url = new URL("http://54.175.175.238:8000/Ferris");
            ...
            if(urlConnection.getResponseCode() == HttpURLConnection.HTTP_OK){
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    public void onItemClick(AdapterView<?> parent, View view,
                        ...
                        edit.putString("diningHall", "Ferris");
                        edit.apply();
